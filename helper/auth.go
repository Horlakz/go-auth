...
func (a *jw) CheckTokenType(tokenType string) TokenType {
...
func (a *jw) CreateToken(userId string, tokenType string) (string, error) {
...
func (a *jw) ExtractUserID(token string, tokenType string) (uid uuid.UUID, err error) {
	tType := a.CheckTokenType(tokenType)
...
func (a *jw) ExtractBearerToken(r *fasthttp.Request) string {
...
func (a *jw) ExtractTokenObject(tokenString string, secret string) (*jwt.Token, error) {
...
func (a *jw) Pretty(data interface{}) {
